...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Reanimator & Shmunj"
        self.author_email = "quest.for.eutopia@gmail.com"
        self.copyright = "Copyright (c) 2014 Reanimator & Bora Chola"
        ...
        self.extra_datas = ['font','img','snd','nodes']
